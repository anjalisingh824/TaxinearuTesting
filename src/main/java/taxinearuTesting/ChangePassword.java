...
public class ChangePassword {
	...
	public void testTaxinaru() throws Exception {
		...
		Function.loginPage(driver, 1, 1, 2, Constant.SHEET_NAME);
		...
		// validation value 1 check for pass and conf pass
		Function.changePasswordAlternate(driver, 9, 1, 2, Constant.CHANGEPWD_ERRORMSG_BYALTERNATE);
		Thread.sleep(5000);
		Log.info("CHANGE PASSWORD ERROR MESSAGE VALIDATION 1 SUCCESSFUL");
		...
		// taking validation value 2 from row 4
		Function.changePasswordAlternate(driver, 10, 1, 2, Constant.CHANGEPWD_ERRORMSG_BYALTERNATE);
		...
		// taking validation value 3 from excel
		Function.changePasswordAlternate(driver, 11, 1, 2, Constant.CHANGEPWD_ERRORMSG_BYALTERNATE);
		Thread.sleep(5000);
		Log.info("CHANGE PASSWORD ERROR MESSAGE VALIDATION 3 SUCCESSFUL");
		...
		Function.changePasswordAlternate(driver, 12, 1, 2, Constant.PASSWORD_MISMATCHE );
		Thread.sleep(5000);
		Log.info("CHANGE PASSWORD ERROR MESSAGE VALIDATION 4 SUCCESSFUL");
		...
		// enter the new and confirm password
		Function.changePasswordAlternate(driver, 13, 1, 2, Constant.PWD_UPDATE_MSG);
