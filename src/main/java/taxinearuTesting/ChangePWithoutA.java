...
public class ChangePWithoutA {
	...
	public void testTaxinaru() throws Exception {
		...
		Function.loginPage(driver, 1, 1, 2, Constant.SHEET_NAME5);
		...
		Function.readEmail(driver, Constant.CONNECTION_EMAIL, Constant.EMAIL, Constant.EMAIL_PASSWORD, 45000);
		...
		int row1 = 3;
		driver.findElement(By.id("newPassword")).sendKeys(ExcelUtils.getCellData(row1, 1, Constant.SHEET_NAME5));
		driver.findElement(By.id("confPassword")).sendKeys(ExcelUtils.getCellData(row1, 2, Constant.SHEET_NAME5));
		...
		if (changePassword.equals(Constant.CHANGEPASSWORDE_MSG)) {
			Log.info("PASS");
			ExcelUtils.setCellData("PASS", row1, 4, Constant.SHEET_NAME5);
		} else {
			Log.info("FAIL");
			ExcelUtils.setCellData("FAIL", row1, 4, Constant.SHEET_NAME5);
		}
		...
		int row2 = 4;
		driver.findElement(By.id("newPassword")).sendKeys(ExcelUtils.getCellData(row2, 1, Constant.SHEET_NAME5));
		driver.findElement(By.id("confPassword")).sendKeys(ExcelUtils.getCellData(row2, 2, Constant.SHEET_NAME5));
		...
		if (changePassword1.equals(Constant.CHANGEPASSWORDE_MSG)) {
			Log.info("PASS");
			ExcelUtils.setCellData("PASS", row2, 4, Constant.SHEET_NAME5);
		} else {
			Log.info("FAIL");
			ExcelUtils.setCellData("FAIL", row2, 4, Constant.SHEET_NAME5);
		}
		...
		int row3 = 5;
		driver.findElement(By.id("newPassword")).sendKeys(ExcelUtils.getCellData(row3, 1, Constant.SHEET_NAME5));
		driver.findElement(By.id("confPassword")).sendKeys(ExcelUtils.getCellData(row3, 2, Constant.SHEET_NAME5));
		...
		if (changePassword2.equals(Constant.CHANGEPASSWORDE_MSG)) {
			Log.info("PASS");
			ExcelUtils.setCellData("PASS", row3, 4, Constant.SHEET_NAME5);
		} else {
			Log.info("FAIL");
			ExcelUtils.setCellData("FAIL", row3, 4, Constant.SHEET_NAME5);
		}
		...
		driver.findElement(By.id("newPassword")).sendKeys(ExcelUtils.getCellData(row4, 1, Constant.SHEET_NAME5));
		driver.findElement(By.id("confPassword")).sendKeys(ExcelUtils.getCellData(row4, 2, Constant.SHEET_NAME5));
		...
		if (changePassword3.equals(Constant.PASSWORD_MISMATCH_ERROR)) {
			Log.info("PASS");
			ExcelUtils.setCellData("PASS", row4, 4, Constant.SHEET_NAME5);
		} else {
			Log.info("FAIL");
			ExcelUtils.setCellData("FAIL", row4, 4, Constant.SHEET_NAME5);
		}
		...
		driver.findElement(By.id("newPassword")).sendKeys(ExcelUtils.getCellData(row5, 1, Constant.SHEET_NAME5));
		driver.findElement(By.id("confPassword")).sendKeys(ExcelUtils.getCellData(row5, 2, Constant.SHEET_NAME5));
		Thread.sleep(2000);
		...
		if (driver.getPageSource().contains(Constant.PASSWORD_CHANGED_SUCCESSMSG)) {
			Log.info("PASS");
			ExcelUtils.setCellData("PASS", row5, 4, Constant.SHEET_NAME5);
		} else {
			Log.info("FAIL");
			ExcelUtils.setCellData("FAIL", row5, 4, Constant.SHEET_NAME5);
		}
		...
		Function.readEmail(driver, Constant.CONNECTION_EMAIL, Constant.EMAIL, Constant.EMAIL_PASSWORD, 5000);
		...
		//Change password by security questions
