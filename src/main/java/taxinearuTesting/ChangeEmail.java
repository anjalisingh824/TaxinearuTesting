...
public class ChangeEmail {
	...
	public void testTaxinaru() throws Exception {
...

		{
			...
			Log.info("EMAIL UPDATE SUCCESS MESSAGE NOT PRESENT");
	...
	@Test(priority = 1)
	public void testTaxineru() throws Exception {
		...
		driver.findElement(
				...
				.sendKeys(ExcelUtils.getCellData(row2, 1, Constant.SHEET_NAME));
		driver.findElement(
				By.xpath("//html/body/div[3]/div/div/div/div/div[2]/div/div/div[3]/div/div/div/div[2]/div/input[2]"))
				.sendKeys(ExcelUtils.getCellData(row2, 2, Constant.SHEET_NAME));
		...
		int row3 = 19;
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row3, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row3, 2, Constant.SHEET_NAME1));
		...
		if (validEmailError.contains(Constant.CHECK_EMAIL_ERROR)) {
			...
			Log.info("ENTER VALID EMAIL ADDRESS ERROR NOT PRESENT");
			ExcelUtils.setCellData("FAIL", row3, 4, Constant.SHEET_NAME1);
		}
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row4, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row4, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row5, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row5, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row6, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row6, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row7, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row7, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row8, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row8, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row9, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row9, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row10, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row10, 2, Constant.SHEET_NAME1));
		...
		driver.findElement(By.id("txtEmailId")).sendKeys(ExcelUtils.getCellData(row11, 1, Constant.SHEET_NAME1));
		driver.findElement(By.id("txtConfirmEmailId")).sendKeys(ExcelUtils.getCellData(row11, 2, Constant.SHEET_NAME1));

		// click on the confirm button of the email change page
		driver.findElement(By.xpath("//html/body/div[3]/div/div/div/div/div[2]/div/div/form[2]/div/div/div[4]/input"))
				.click();

		String validEmailErro8 = driver
				.findElement(By
						.xpath("//html/body/div[3]/div/div/div/div/div[2]/div/div/form[2]/div/div/div[2]/div[2]/label"))
				.getText();
		if (validEmailErro8.contains(Constant.CHECK_EMAIL_ERROR)) {
			Log.info("ENTER VALID EMAIL ADDRESS ERROR PRESENT");
			ExcelUtils.setCellData("PASS", row11, 4, Constant.SHEET_NAME1);
		} else {
			Log.info("ENTER VALID EMAIL ADDRESS ERROR NOT PRESENT");
		...
		String validEmailErro9 = driver
				.findElement(By
						.xpath("//html/body/div[3]/div/div/div/div/div[2]/div/div/form[2]/div/div/div[2]/div[2]/label"))
				.getText();
		if (validEmailErro9.contains(Constant.CHECK_EMAIL_ERROR)) {
			Log.info("ENTER VALID EMAIL ADDRESS ERROR PRESENT");
