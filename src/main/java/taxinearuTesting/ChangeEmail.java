...
public class ChangeEmail {
	...
	public void testTaxinaru() throws Exception {
		...
		// CHANGING EMAIL BY SENDING MAIL TO THE ALTERNATE MAIL ID

		// click on the LOGIN./SIGNUP
		driver.findElement(By.xpath("//*[@id='loginsignuplink']")).click();
		Thread.sleep(5000);

		Function.loginPage(driver, 32, 1, 2, Constant.SHEET_NAME1);
		...
		String EmailError = driver.findElement(By.xpath("//html/body/div[3]/div/div/form/div/label[1]")).getText();
		if (EmailError.contains(Constant.ENTER_EMAIL_ERROR)) {
			Log.info("ENTER  EMAIL ADRRESS ERROR PRESENT");
		} else {
			Log.error("ENETER EMAIL ADDRESS ERROR IS NOT PRESENT");
		...
		String confirmEmailErr = driver.findElement(By.xpath("//html/body/div[3]/div/div/form/div/label[2]")).getText();
		if (confirmEmailErr.contains(Constant.ENTER_EMAIL_ERROR1)) {
			Log.info("ENTER CONFIRM EMAIL ADDRESS ERROR PRESENT");
		} else {
			Log.error("ENTER CONFIRM EMAIL ADDRESS ERROR IS NOT PRESENT");
		}

		// check for the validation value 1
		Function.changeEmail(driver, 34, 1, 2, 1);
		Log.info("VALIDATION VALUE 1 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 35, 1, 2, 1);
		Log.info("VALIDATION VALUE 2 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 36, 1, 2, 1);
		Log.info("VALIDATION VALUE 3 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 37, 1, 2, 1);
		Log.info("VALIDATION VALUE 4 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 38, 1, 2, 1);
		Log.info("VALIDATION VALUE 5 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 39, 1, 2, 1);
		Log.info("VALIDATION VALUE 6 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 40, 1, 2, 1);
		Log.info("VALIDATION VALUE 7 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 41, 1, 2, 1);
		Log.info("VALIDATION VALUE 8 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 43, 1, 2, 2);
		Log.info("VALIDATION VALUE 10 SUCCESSFULLY EXECUTED");
		...
		Function.changeEmail(driver, 44, 1, 2, 3);
		Log.info("VALIDATION VALUE 11 SUCCESSFULLY EXECUTED");
		...
		// finally passing confirm values
		Function.changeEmail(driver, 45, 1, 2, 4);
		Log.info("CONFIRM VALUES EXECUTED SUCCESSFULLY");
