...
public class LoginPage {
	...
	public void testTaxinaru() throws Exception {
		...
		Thread.sleep(2000);
		Log.info("PASSWORD CHANGE CONFIRM BUTTON CLICKED...SO THE MAIL IS SEND TO THE PRIMARY EMAIL ID");
		Thread.sleep(5000);
...
//		 }
		...
		// String changePassword4 =
		// driver.findElement(By.xpath("//html/body/div[5]/span[3]")).getText();
		// System.out.println(changePassword4);
		// if (changePassword4.equals(Constant.PASSWORD_CHANGED_SUCCESSMSG)) {
		// Log.info("PASS");
		// ExcelUtils.setCellData("PASS", row5, 4);
		// } else {
		// Log.info("FAIL");
		// ExcelUtils.setCellData("FAIL", row5, 4);
		// }
