...
public class LoginPage {
	...
	public void testTaxinaru() throws Exception {
		...
		int row3 = 5;
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row3, 1, Constant.SHEET_NAME));
		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row3, 2, Constant.SHEET_NAME));
		...
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row4, 1, Constant.SHEET_NAME));
		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row4, 2, Constant.SHEET_NAME));
		...
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row5, 1, Constant.SHEET_NAME));
		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row5, 2, Constant.SHEET_NAME));
		Thread.sleep(2000);
		...
		Function.readEmail(driver, Constant.CONNECTION_EMAIL, Constant.PRIMARY_EMAIL, Constant.PRIMARY_EMAIL_PASSWORD,5000);
		...
		// Thread.sleep(5000);
		//
		// // click on the submit button and the mail is send to the alternate
		// mail
		// // id .
		// driver.findElement(By.id("btnRequest")).click();
		// Thread.sleep(2000);
		// Log.info("PASSWORD CHANGE CONFIRM BUTTON CLICKED...FROM POP UP
		// WINDOW");
		//
		// // selecting readEmail function to read mail and open browser
		// Function.readEmail(driver, Constant.CONNECTION_EMAIL,
		// Constant.ALTERNATE_EMAIL, Constant.ALTERNATE_EMAIL_PASSWORD);
		//
		// System.out.println(Function.link);
		// System.out.println(Function.link.length());
		// Function.get = Function.link.substring(8, Function.link.length() -
		// 1);
		// System.out.println(Function.get);
		// Thread.sleep(15000);
		// driver.get(Function.get);
		...
		//
		// String changePass =
		// driver.findElement(By.xpath("//body[@id='wrapper']/div[5]/span[3]")).getText();
		...
		//
		// String changePass3 =
		// driver.findElement(By.xpath("//div/span[3]")).getText();
		...
		// driver.findElement(By.xpath("//html/body/div[3]/div/div/div[2]/center/input")).click();
		// if
		// (driver.getPageSource().contains(Constant.PASSWORD_CHANGED_SUCCESSMSG))
		// {
		// Log.info("PASS");
		...
		int row12 = 16;
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row12, 1, Constant.SHEET_NAME));

		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row12, 2, Constant.SHEET_NAME));
		...
		int row13 = 17;
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row13, 1, Constant.SHEET_NAME));

		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row13, 2, Constant.SHEET_NAME));
		...
		int row14 = 18;
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row14, 1, Constant.SHEET_NAME));

		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row14, 2, Constant.SHEET_NAME));
		...
		int row15 = 19;
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row15, 1, Constant.SHEET_NAME));

		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row15, 2, Constant.SHEET_NAME));
		...
		int row16 = 20;
		driver.findElement(By.id("newPassword"))
				.sendKeys(ExcelUtils.getCellData(row16, 1, Constant.SHEET_NAME));

		driver.findElement(By.id("confPassword"))
				.sendKeys(ExcelUtils.getCellData(row16, 2, Constant.SHEET_NAME));
