...
public class BookTomorrow {
	...
	public void testTaxinaru() throws Exception {
		...
		Function.bookingTaxiTommorow(driver, 11);
		Thread.sleep(2000);
		...
		Function.dropDown(driver, 12, 5, Constant.SHEET_NAME6);
		Thread.sleep(2000);

		// change the people's value
		Function.dropDown(driver, 12, 6, Constant.SHEET_NAME6);
		Thread.sleep(2000);
		...
		// click on the saved card
		driver.findElement(
				By.xpath("//html/body/div[3]/div[1]/div/div/div/div[3]/div/div[1]/div/div/div[1]/ul/li[3]/span"))
				.click();
		Thread.sleep(2000);

		// check the card
		driver.findElement(By
				.xpath("//html/body/div[3]/div[1]/div/div/div/div[3]/div/div[1]/div/div/div[2]/div[3]/div[2]/div/div[1]/span/label"))
				.click();
		Thread.sleep(2000);

		// now click on the pay now
